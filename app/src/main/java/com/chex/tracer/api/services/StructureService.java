...
public abstract class StructureService {
    ...
    public static final String SOCIAL_MEDIA_DATA = BASE_USER + "socialmediadata/";
    ...
    public static final String CHANGE_FOLLOW_STATUS = BASE_USER + "changefollowstatus/";
    ...
    public static final String GET_FRIENDS_ACTIVITY = BASE_VG + "friendsActivity/{userId}";
    ...
    public static final String GET_USER_GAME_LIST = BASE_VG + "{userId}/{list}/";

    //REVIEW
    public static final String BASE_REVIEW = "review/";
    public static final String GET_USER_REVIEWS = BASE_REVIEW + "/{userId}";
    public static final String GET_LATEST_REVIEWS = BASE_REVIEW + "/latest";
